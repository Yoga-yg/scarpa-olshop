    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-1 d-flex justify-content-center mb-2">
                <a href=" https://wa.me/085863516152"><i class="fab fa-whatsapp fs-2"></i></a>
            </div>
            <div class="col-sm-1 d-flex justify-content-center mb-2">
                <a href="https://ig.me/m/_rizkyyoga4"><i class="fab fa-instagram fs-2"></i></a>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid py-3 bg-dark text-light">
    <div class="container d-flex justify-content-between">
        <label>&copy;2023 Scarpa Shop</label>
        <label>Created by Scarpa</label>
    </div>
</div>