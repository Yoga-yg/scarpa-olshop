        ...
        <div class="my-5 col-12 col-md-6 mb-5">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="number" class="form-control mt-1 mb-1" name="harga" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea name="detail" id="detail" cols="30" rows="10" class="form-control mt-1 mb-1"></textarea>
                </div>
                <div>
                    <label for="ketersediaan_stok">Ketersediaan Stok</label>
                    <select name="ketersediaan_stok" id="ketersediaan_stok" class="form-control mt-1 mb-1">
                ...
                <div>
                    ...
                    <input type="number" class="form-control mt-1 mb-3" name="jumlah_stok" required>
                </div>
                <div>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>                                        
                                    ...
                                    <td>
                                        <a href="produk-detail.php?y=<?php echo $data['id']; ?>" class="btn btn-info warna-button"><i class="fas fa-search"></i></a>
                                    </td>
                                </tr>
                        <?php
                                $jumlah++;
